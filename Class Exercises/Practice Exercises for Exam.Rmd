...
# Your code here
#1
plot(x = Boston$medv, y = Boston$lstat, xlim = c(0, 55), ylim = c(0, 55), xlab = "median value", ylab = "lower status population", main = "medv vs lstat")
#2
hist(Boston$crim, main = "Histogram of Boston criminal", cex.lab = 1.2, cex.axis = 1.2, col = "lightgray", xlab = "per capita crime rate by town")
#3
barplot(table(Boston$chas), col = c(2, 3), main = "Charles River dummy variable", beside = TRUE, ylim = c(0, 100), cex.axis = 1.2)
```
...
# Your code here
#1
barplot(table(students$Major), col = c(2,3), main = "Number of students in each Major", cex.axis = 1.2, ylim = c(0, 3), ylab = "Frequency", xlab = "Majors")
#2
pie(table(students$Major), main = "Number of students in each Major", col = c(2,3,4), cex=1.3)
```
...
```{r}
# Your code here
plot(x = cars$speed, y = cars$dist, xlim = c(0, 30), ylim = c(0, 130), xlab = "Speed of Cars", ylab = "Distance of Cars", main = "Speed vs Distance of Cars")
```
...
library(ggplot2)
#2
plot(x = mpg$displ, y = mpg$hwy, xlim = c(0, 10), ylim = c(0,55), xlab = "displ", ylab = "hwy", main = "displ vs hwy")
#3
barplot(table(mpg$class), col = c(2,3,4,5), main = "Number of each car's classes", cex.axis = 1.2, ylim = c(0, 70), ylab = "Frequency", xlab = "Classes")
#4
hist(mpg$cty, main = "City miles per gallon", cex.lab = 1.2, cex.axis = 1.2, col = "lightgray", xlab = "city miles per gallon(miles/gallon")
```
...
# Your code here
#1
ggplot(mpg, aes(x = displ, y = hwy, colour = class)) + geom_point(size = 2) + xlim(0, 10) + ylim(10,55) + labs(title = "Scaterplot of displ vs hwy", y = "hwy", x = "displ", subtitle = "Generated by ggplot in R") + geom_smooth() +  facet_wrap(~year)
```
...
table(iris$Species)
#2
barplot(table(iris$Species), col = c(2,3,4,5), main = "Number of iris' species", cex.axis = 1.2, ylim = c(0, 55), ylab = "Frequency", xlab = "Species")
```
